...
exports.getComponent = jswrapper({
    ...
    updater: function( chcs ) {  
        ...
        console.log('\nenter shex-chcs-to-rdf updater');
        console.log( JSON.stringify( chcs ) );
