...
/**
 * Builds and returns a new last modified (Lm) object 
 *
 * @return the new LM 
 */
function Lm() { 
...
/**
 * Builds a new, unique to the node instance, Lm string.  The factory returns the lm as a
 * primitive string to enable easy, foolproof comparisons.
 */
