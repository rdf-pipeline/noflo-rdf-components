...
var translationWrapper = require('../src/translation-wrapper');
...
describe('translation-wrapper', function() {
   commonWrapper(translationWrapper, DEFAULT_NUMBER_OF_PORTS);

   describe('Wrapper specific tests', function() {

        describe('#fRunUpdater', function() {

            xit("should fail if not given a vnid hash", function() {

                return new Promise(function(done) {
                    var node = commonTest.createComponent(translationWrapper({ inPorts:['input'] }));
            ...
            it("should generate vnid hash port and run updater when passed only an updater", function() {
                ...
                var node = commonTest.createComponent(translationWrapper(updater));
            ...
            it("should call updater with VNI context", function() {
                ...
                var node =
                    commonTest.createComponent(translationWrapper(updater));
        ...
        describe('functional behavior', function() {
            ...
            it("should execute in a noflo network", function() {
                ...
                return commonTest.createNetwork({
                    ...
                    nodeS: translationWrapper({
                        inPorts:{input: {required: true}},
                    ...
                    return new Promise(function(done) {
                        ...
                        network.graph.addEdge('nodeA', 'output', 'nodeS', 'input');
            ...
            it("should send multiple messages with a multi-element hash in a noflo network", function() {
                ...
                return commonTest.createNetwork(
                    { nodeA: 'rdf-components/parse-json',
                      nodeS: { getComponent:
                                  translationWrapper({ inPorts:{ input: { required: true } },
                                                 updater: function(input) {
                                                     return input;
                                                 }
                                  })
