    ...
    describe('#updater', function() {
        ...
        it("should log a warning if file_envvar referenced file has no content", function() {
            ...
            fs.writeFile(testfile, '', function() { 
                ...
                var result = factory.updater.call(node.vni(''), "1", 'testEnvVar');
                logger.warn.restore();
		warning.should.be.a('string');
		warning.should.equal("No data found in " + process.env.testEnvVar);
           });
        });
        ...
        it('should run in  a noflo network', function() {
            ...
            return test.createNetwork(
                ...
                return new Promise(function(done, fail) {
                    ...
                    network.graph.addInitial('testEnvVar', 'filevar', 'in');
