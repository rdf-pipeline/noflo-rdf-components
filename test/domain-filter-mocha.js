...
describe('domain-filter', function() {
    ...
    describe('#updater', function() {
        ...
        it('should extract demographics from CHCS', function() {
            ...
            var demographics = factory.updater.call(vni, jsonData, 'demographics', 'chcss');
            ...
            demographics[0].type.should.equal("chcss:Patient-2");
        ...
        it('should extract diagnoses from CHCS', function() {
            ...
            var diagnoses = factory.updater.call(vni, jsonData, 'diagnoses', 'chcss');
            ...
            diagnoses[0].type.should.equal("chcss:Kg_Patient_Diagnosis-100417");
            ...
            diagnoses[1].type.should.equal("chcss:Kg_Patient_Diagnosis-100417");
            ...
            diagnoses[2].type.should.equal("chcss:Kg_Patient_Diagnosis-100417");
        ...
        it('should extract labs from CHCS', function() {
            var node = test.createComponent(factory);
            var vni = node.vni('');

            var labwork = factory.updater.call(vni, jsonData, 'labs', 'chcss');
            ...
            labwork[0].type.should.equal("chcss:Lab_Result-63");
        ...
        it('should extract prescriptions from CHCS', function() {
            ...
            var prescriptions = factory.updater.call(vni, jsonData, 'prescriptions', 'chcss');
