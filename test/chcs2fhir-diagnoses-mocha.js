...
var factory = require('../components/chcs2fhir-diagnoses');
var logger = require('../src/logger');
var test = require('./common-test');

var testFile = __dirname + '/data/chcs-patient7.jsonld';

describe('chcsfhir-diagnoses', function() {
    ...
    describe('#updater', function() {
        ...
        it('should throw an error if data is undefined', function() {
            expect(factory.updater.bind(this, undefined)).to.throw(Error,
                /Chcs2fhir diagnoses component requires data to translate!/);
        });
       ...
       it('should convert patient diagnoses to fhir in a noflo network', function() {
           ...
           return test.createNetwork(
                { chcsFile: 'core/Repeat',
                  ...
                  translator: 'rdf-components/chcs2fhir-diagnoses'
                ...
                return new Promise(function(done, fail) {
                    ...
                    network.graph.addInitial('/tmp/patient-7-diagnoses-chcs.jsonld', 'chcsFile', 'in');
                    ...
                    done.componentName.should.equal('rdf-components/chcs2fhir-diagnoses');
